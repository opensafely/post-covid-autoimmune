...
# active_analyses <- active_analyses[active_analyses$analysis == "main",] #temporary
# 
# active_analyses <- active_analyses %>%
#   dplyr::mutate(outcome = dplyr::recode(outcome, "out_date_pa" = "out_date_psoa"), #temporary
#          name = dplyr::recode(name, "out_date_pa" = "out_date_psoa"))
