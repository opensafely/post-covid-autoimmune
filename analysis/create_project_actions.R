...
apply_model_function <- function(name, cohort, analysis, ipw, strata,
  ...
  splice(
    action(
      ...
      #needs = list("stage1_data_cleaning_prevax", "stage1_data_cleaning_vax", "stage1_data_cleaning_unvax"),
      needs = list("preprocess_stage1_data_cleaning_history_prevax", "preprocess_stage1_data_cleaning_history_vax", "preprocess_stage1_data_cleaning_history_unvax"),
      highly_sensitive = list(
...
actions_list <- splice(
  ...
  #                "generate_study_population_history_prevax", "generate_study_population_history_vax", "generate_study_population_history_unvax",
  #                "join_study_definitions_prevax", "join_study_definitions_vax", "join_study_definitions_unvax"),
  #   moderately_sensitive=list(
